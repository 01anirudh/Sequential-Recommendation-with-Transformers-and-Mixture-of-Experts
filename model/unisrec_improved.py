...
class UniSRecImproved(SASRec):
    ...
    def __init__(self, config, dataset):
        ...
        self.use_deep_moe = get_flag('use_deep_moe')
        self.use_layer_aggregation = get_flag('use_layer_aggregation')
        self.use_learnable_temperature = get_flag('use_learnable_temperature')
        self.use_label_smoothing = get_flag('use_label_smoothing')

        print(f"DEBUG :: UniSRecImproved Configuration:")
        print(f"  > use_deep_moe:              {self.use_deep_moe}")
        print(f"  > use_layer_aggregation:     {self.use_layer_aggregation}")
        print(f"  > use_learnable_temperature: {self.use_learnable_temperature}")
        print(f"  > use_label_smoothing:       {self.use_label_smoothing}")
        # ----------------------------
        ...
        # Learnable temperature vs fixed temperature
        ...
        if self.use_learnable_temperature:
            ...
            self.fixed_temperature = init_temp
        ...
        # Enhanced MoE adapter vs Baseline
        if self.use_deep_moe:
