"""
DistilRoBERTa Sequential Recommender
Simplified version based on UniSRec architecture
"""
...
class DistilRoBERTaRec(SASRec):
    """
    DistilRoBERTa based sequential recommender.
    Uses pre-computed DistilRoBERTa embeddings with a simple adapter layer.
    """
