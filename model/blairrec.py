"""
BlairRec Sequential Recommender
Simplified version of UniSRec architecture containing NO MoE Adaptor layer.
Behaves similarly to QwenRec but utilizes the Blair textual embeddings.
"""
...
class BlairRec(SASRec):
    """
    Blair based sequential recommender.
    Uses pre-computed Blair embeddings with a simple linear adapter layer.
    """
    ...
    def __init__(self, config, dataset):
        ...
        # Simple adapter to project PLM embeddings to hidden_size natively
