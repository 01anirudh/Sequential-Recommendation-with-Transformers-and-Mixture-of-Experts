"""
Mistral Sequential Recommender
...
class MistralRec(SASRec):
    """
    Mistral based sequential recommender.
    Uses pre-computed Mistral embeddings with a simple adapter layer.
    """
