"""
FLAN-T5-Small Sequential Recommender
...
class FlanT5SmallRec(SASRec):
    """
    FLAN-T5-Small based sequential recommender.
    Uses pre-computed FLAN-T5-Small embeddings with a simple adapter layer.
    """
