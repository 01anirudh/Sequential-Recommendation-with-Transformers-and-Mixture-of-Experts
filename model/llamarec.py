"""
LLaMA Sequential Recommender
Based on SASRec architecture with LLaMA-3-8B embeddings
"""
...
class LLaMARec(SASRec):
    """
    LLaMA-3-8B based sequential recommender.
    Uses pre-computed LLaMA embeddings with a simple adapter layer.
    """
